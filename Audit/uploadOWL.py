...
def uploadOWL(request, ontology_path, conf="", make_config=False):
    ...
    SUCCESS = True
    ERROR_TEXT = ""
    def extend_error_text(new_text):
        nonlocal ERROR_TEXT
    ...
    try:
        ...
        with transaction.atomic():
            try:
                ...
                extend_error_text("Error creating categories. Make sure the ontology is valid and matches the configuration.")
                SUCCESS = False
            ...
            try:
                ...
                extend_error_text(f"Error creating questions. Make sure the ontology is valid and matches the configuration.<br>Failed on question '{question.iri}'")
                SUCCESS = False
                raise ValueError("Abort transaction")
...
""")
        ...
        extend_error_text("Couldn't upload OWL. Aborted all changes.")
